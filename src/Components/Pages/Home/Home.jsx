    ...
    <div className={styles.wrapper + " roboto mid"}>
      ...
      <div className={styles.content + " mid"}>
        <div className={styles.tagline}>
          OK, let's get you a perfect resume!
        </div>
        <div className={styles.que}>What would you like to do first ?</div>
        <Link to="/details" className={styles.button}>
          Enter Details
        </Link>
        <Link to="/templates" className={styles.button}>
          Browse Templates
        </Link>
      </div>
      ...
      >
        <ion-icon color="light" size="large" name="logo-github"></ion-icon>
      </a>
    </div>
  );
};
